		...
		<div className="h-screen flex flex-col bg-[#FFEBCD] max-w-md mx-auto">
			...
			<div className="px-4 py-2 text-center">
				<button
					...
					className="text-xs text-[#3D2819]/40 hover:text-[#3D2819]/70 underline"
				>
					Reset onboarding
				</button>
			</div>
				...
				<div className="flex items-center justify-around">
					<button
						...
						className={`flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition-colors ${
							activeTab === "home" ? "text-[#FFEBCD]" : "text-white/60 hover:text-white/80"
						}`}
					>
					...
					<button
						...
						className={`flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition-colors ${
							activeTab === "community" ? "text-[#FFEBCD]" : "text-white/60 hover:text-white/80"
						}`}
					>
					...
					<button
						...
						className={`flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition-colors ${
							activeTab === "tracking" ? "text-[#FFEBCD]" : "text-white/60 hover:text-white/80"
						}`}
					>
					...
					<button
						...
						className={`flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition-colors ${
							activeTab === "algorithms" ? "text-[#FFEBCD]" : "text-white/60 hover:text-white/80"
						}`}
					>
					...
					<button
						...
						className={`flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition-colors ${
							activeTab === "find" ? "text-[#FFEBCD]" : "text-white/60 hover:text-white/80"
						}`}
					>
